...
public class Contrato implements Serializable {
	...
	public Contrato(int idContrato, byte avisoPolicia, String codpostal, String direccion, byte estado,
			String poblacion, String provincia, Cliente cliente) {
		super();
